...
public class GuiRGB extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.controlList.add(r=new RGBSlider(2, this.width / 2 - 155, height, "Red", 1.0F, 0));
        this.controlList.add(g=new RGBSlider(3, this.width / 2 - 155, height+22, "Green", 1.0F, 1));
        this.controlList.add(b=new RGBSlider(4, this.width / 2 - 155, height+22+22, "Blue", 1.0F, 2));
        this.controlList.add(new GuiSmallButton(0, this.width / 2 - (155/2), this.height / 3 + 55, "Reset to Default"));
        this.controlList.add(new GuiSmallButton(0, this.width / 2 - 155 + 0, this.height / 3 + 96, "Yes"));
        this.controlList.add(new GuiSmallButton(1, this.width / 2 - 155 + 160, this.height / 3 + 96, "No"));
    }
